...
def slice_spot(image, h=20, w=20, edge=(5,5),
               mask=None, diz_threshold=1.5, diz_size=3
              ): 
    """
    Parameters
    ----------
...
def slice_dark(image, h=20, w=20, edge=(5,5),
               mask=None, beamspot=(75,75), darkside='LHS'
              ): 
    """
    Parameters
    ----------
...
def load_fits(file):
    ...
    with fits.open(file) as hdul:
            ...
            out['ai3'] = hdul[0].header['HIERARCH AI 3 Izero']
            out['header'] = hdul[0].header
    return out
