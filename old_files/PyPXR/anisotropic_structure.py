...
from anisotropic_reflectivity import PXR_reflectivity
...
class PXR_Structure(UserList):
    ...
    reverse_structure : bool
        If `Structure.reverse_structure` is `True` then the slab representation produced by `Structure.slabs` is reversed.
    ...
    def tensor(self, energy=None):
        ...
        Notes
        -----
        Output as a (3, 3) np.ndarray is used for broadcasting in later calculations. All off-diagonal elements are zero.
